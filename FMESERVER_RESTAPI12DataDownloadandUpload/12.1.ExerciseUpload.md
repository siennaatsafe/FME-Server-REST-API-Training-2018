...
### Add an Area to Drag and Drop Files
...
**37) Add the CSS for the Drag and Drop Box.**

***Please note this should already be in your script but will not work without it so double check it is there***
...
**38) Change the buildOptions functions.**
...
**39) Paste in the following code for the drag and drop box.**
