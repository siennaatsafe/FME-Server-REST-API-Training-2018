...
This workspace creates creates an HTML file if the data is not valid to make the user aware where the issues exist. However, if the data isvalid it will be returned as an KML which can be used to stream back website.
