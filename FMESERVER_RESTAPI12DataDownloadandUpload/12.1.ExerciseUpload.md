...
### Customize for Data Validation TEST
...
streaming component.
         ...
         resultUrl= 'https://bluesky-safe-software.fmecloud.com/fmedatastreaming/' +
          repository + '/' + workspace + ' ?SourceDataset_ACAD=%24(FME_SHAREDRESOURCE_SYSTEM)%2Ftemp%2Fupload%2F'
           + repository + '%2F' + workspace + '%2F' +  jsid + '%2F' + filename;
...
following:**
    ...
    <p> If the file passes the Quality Analysis process, the map will display the features in the correct location. Then the user will be presented with the KML link. </p>
...
layer is loading.
    ...
    //	}
      ...
      resultUrl= 'https://bluesky-safe-software.fmecloud.com/fmedatastreaming/' + repository + workspace + '?SourceDataset_ACAD=%24(FME_SHAREDRESOURCE_SYSTEM)%2Ftemp%2Fupload%2F + repository +
      '%2F' + workspace + '%2F' +  jsid + '%2F' + filename;
...
![](./Images/12.1.17.DragandDrop.png)

*12.1.17 Web Application with Drag and Drop Files*
...
Delete the code where indicated.
...
Paste in the following code:
       ...
       for( var i in inputs ) {
          ...
          //*** End of section to copy and paste
...
![](./Images/12.1.18.Elements.png)

*12.1.18 Drag and Drop Elements*
...
![](./Images/12.1.19.ExplorerCode.png)
*12.1.19. Internet Explorer Code*
...
![](./Images/12.1.20.OtherBrowsers.png)

*12.1.20 Code for Other Browsers*
