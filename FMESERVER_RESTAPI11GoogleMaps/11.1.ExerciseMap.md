...
![](./Images/11.3.1.OnloadFunctions.png)
*11.3.1. Onload Functions*

When the window is loaded, the map and the drawing tools are initialized
from google maps.

![](./Images/11.3.2.Geometry.png)

*11.3.2. Google Maps Geometry*

The above code creates events for every type of geometry and connects to
the FME Server.

![](./Images/11.3.3.CreateGeometry.png)

*11.3.3. Google Maps Geometry Creation*
...
![](./Images/11.3.4.Parameter.png)

*11.3.4. Create the Geom Parameter*
...
![](./Images/11.4.1.WorkspaceOverview.png)
...
![](./Images/11.4.2.GeoReplace.png)

*11.4.2. Geometry Replacer*
...
![](./Images/11.4.3.GeoUserParam.png)

*11.4.3. Geometry User Parameter*
...
![](./Images/11.4.4.DriveBC.png)

*11.4.4. Drive BC API Workspace Overview*
...
![](./Images/11.4.5.HTTPCaller.png)

*11.4.5. HTTP Caller Parameter*

Currently, the workspace should look like this:

![](./Images/11.4.6.Creator.png)

*11.4.6. Creator and HTTP Caller*
...
![](./Images/11.4.7.JSONFrag.png)

*11.4.7. JSON Fragmenter*
...
![](./Images/11.4.8.JSONFlat.png)

*11.4.8. JSON Flattener*

**Add another JSONFragmenter**

Now we need to expose the Geography component to create features.

![](./Images/11.4.9.NewJSON.png)

*11.4.9. New JSON Fragmenter*
...
![](./Images/11.4.10.GeoReplace.png)

*11.4.10 Geometry Replacer*

Currently, the workspace should look like this:

![](./Images/11.4.11.Workspace.png)

*11.4.11 Drive BC Workspace*
...
![](./Images/11.4.12.Clipper.png)

*11.4.12 Clipper Transformer*
...
![](./Images/11.4.13.DateTimeConverter.png)

*11.4.13 Date Time Converter*
...
![](./Images/11.4.16.CustomTable.png)

*11.4.16 Custom Table*
...
![](./Images/11.5.1.CenterandZoom.png)

*11.5.1 Center and zoom*
...
![](./Images/11.5.2.DrawingTools.png)

*11.5.2 Drawing Tools*

**Comment Out the Listener Marker and Polyline Functions in the Code**

![](./Images/11.5.3.ListenerFunctions.png)

*11.5.3 Listener Functions*

**Delete the Server Initialization.**

![](./Images/11.5.4.ServerToken.png)

*11.5.4 Delete this section*


**Comment Out the Create Well Known Text Functions For the Point and
Line Section**

![](./Images/11.5.5.Comment.png)

*11.5.5 Comment out point and line sections*
...
![](./Images/11.5.6.DirectURL.png)

*11.5.6 Direct URL Example*
...
![](./Images/11.5.7.DataStreaming.png)

*11.5.7 Data Streaming*

This section sets up the URL with the variables needed from the server.

![](./Images/11.5.8.URLVariables.png)

*11.5.8 Direct URL Variables*

This section creates a new line and div to separate the data download
button.

![](./Images/11.5.9.URL.png)

*11.5.9 Direct URL*

This section combines everything into a URL.

![](./Images/11.5.10.DataDownload.png)

*11.5.10 Data Download Button*
