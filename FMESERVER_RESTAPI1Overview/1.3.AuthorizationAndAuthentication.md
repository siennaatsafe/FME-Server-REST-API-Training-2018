...
When replacing <yourServerHost> with your host nam. You can use localhost if you are working on the machine where server is installed. If you are accessing from a remote machine you need to specify a accessible url either by IP address or server hostname.
