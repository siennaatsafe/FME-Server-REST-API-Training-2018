...
_2.1.1. The Head Section of the HTML_
...
_2.1.3. The form items are created_
...
_2.1.4. A button is created for the form_
...
_2.2.1. Connect to the Server _
...
_2.2.2. Repository and Workspace are assigned_
...
_2.2.3. Get Workspace Parameters_
...
_2.2.4. Workspace Parameters Information_
...
_2.2.5. Generate Form Items Information_
...
_2.3.3. Get the Variables from the first form_
...
_2.3.4. Loop through the parameters_
...
_2.3.5. Create the Parameter String_
...
_2.3.6. Remove the trailing ampersand_

Finally, we can use the runDataDownload function.

![](./Images/2.3.7.RunDataDownload.png)

_2.3.7. Run the Data Download Function_

![](./Images/2.3.8.DataDownload.png)

_2.3.8. Data Download Information_
