...
![](./Images/10.1.1.Head.png)

_10.1.1. The Head Section of the HTML_
...
![](./Images/10.1.2.Form.png)

_10.1.2. The Example Form _
...
![](./Images/10.1.3.Created.png)

_10.1.3. The form items are created_
...
![](./Images/10.1.4.Button.png)

_10.1.4. A button is created for the form_
...
![](./Images/10.1.5.FinalForm.png)

_10.1.5. The final form_
...
![](./Images/10.2.1.ServerConnect.png)

_10.2.1. Connect to the Server _
...
![](./Images/10.2.2.Repository.png)

_10.2.2. Repository and Workspace are assigned_

In this section we are creating variables from the inputs we received  
from the previous form.

![](./Images/10.2.3.workspace.png)

_10.2.3. Get Workspace Parameters_

Then we use the function FMEServer.getWorkspaceParameters to get the  
workspace parameters created in the call.

![](./Images/10.2.4.Parameters.png)

_10.2.4. Workspace Parameters Information_
...
![](./Images/10.2.5.GenerateForm.png)

_10.2.5. Generate Form Items Information_
...
![](./Images/10.2.6.FinalOutput.png)

_10.2.6. Final Output_

If you did not set up your server this will not work properly, until you do. To set up a local server, see this section. LINK TO SECTION.
...
![](./Images/10.3.1.OutputForm.png)

_10.3.1. Get the output form variable _

In this section, we are creating a variable from the existing blank output form.

![](./Images/10.3.2.DataDownload.png)

_10.3.2. Create the Data Download Button_
...
![](./Images/10.3.3.FormVariables.png)

_10.3.3. Get the Variables from the first form_
...
![](./Images/10.3.4.Parameters.png)

_10.3.4. Loop through the parameters_
...
![](./Images/10.3.5.Remove.png)

_10.3.5. Remove the trailing ampersand_

Finally, we can use the runDataDownload function.

![](./Images/10.3.6.RunDataDownload.png)

_10.3.6. Run the Data Download Function_

![](./Images/10.3.7.DataDownload.png)

_10.3.7. Data Download Information_

We named the callback showResults so we can create the showResults  
function which will contain the return.

![](./Images/10.3.8.Results.png)

_10.3.8. Show Results_
