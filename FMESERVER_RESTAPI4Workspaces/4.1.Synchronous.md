...
While synchronous calls are easier to use in a web application compared to asynchronous calls. The application will be stalled until the call is completed. This is a trade-off that should be considered while developing with the FME REST API.
</span>
</td>
</tr>
</table>
