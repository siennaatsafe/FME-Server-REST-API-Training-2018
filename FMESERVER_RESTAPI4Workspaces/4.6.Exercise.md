...
<td style="border: 1px solid darkorange">C:\FMEData2018\Resources\RESTAPI\Chapter6Exercise7.Complete.fmw</td>
</tr>
...
In the beginning of the course we discussed the difference between authentication and authorization. This was referring to the JSON Response sent back from the FME Server. There is a difference between an authentication error and authorization error. However, within the HTTP Caller authenticating or authorizing your call can be used interchangeably.  
</span>
</td>
</tr>
</table>
