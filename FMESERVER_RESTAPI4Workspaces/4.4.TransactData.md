...
<td style="border: 1px solid darkorange">C:\FMEData2018\Workspaces\RESTAPITraining\Chapter4Exercise6.Start</td>
</tr>
<td style="border: 1px solid darkorange; font-weight: bold">Ending Workspace</td>
<td style="border: 1px solid darkorange">C:\FMEData2018\Workspaces\RESTAPITraining\Chapter4Exercise6.End</td>
</tr>
...
![](./Images/image4.4.5.UploadWorkspace.png)

*Image 4.4.5 Upload the Workspace*

**6) Look up your Public IP Address**

Google "my ip address". The first result should be a box from Google with your public IP address.



**7) Add an FME Server Connection**

Go back to your FME Workbench. Then, under connection click, Add Web Connection. The Server URL should be http:// followed by your public IP Address. The User Name and Password should both be admin.   
...
The call is:
    ...
    POST    http://localhost/fmerest/v3/transformations/transactdata/RESTTraining/Chapter4Exercise6.end.fmw


In Postman set up the call with the following parameters.

![](./Images/image4.4.8.CallPostman.png)

*Image 4.4.8 Setting Up the Call in Postman*
...
*Image 4.4.8 Uploading a File Postman*
