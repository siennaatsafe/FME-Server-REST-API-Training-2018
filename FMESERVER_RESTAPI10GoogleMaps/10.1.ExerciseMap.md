...
**1) Create a copy of the html file created during the first exercise, and save it as MySecondApp.html**
...
Publish the workspace to FME Server, and register it with the Job Submitter, Data Download and Data Streaming services.
...
![](./Images/10.1.27a.DataStreaming.png)
