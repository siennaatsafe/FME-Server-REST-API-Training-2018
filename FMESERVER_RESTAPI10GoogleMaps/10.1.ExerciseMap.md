...
**1) Create a copy of the first exercise and title it MySecondApp!**
...
![](./Images/10.1.10.Creator.png)

*10.1.10. Creator and HTTP Caller*
...
*10.1.14 Geometry Replacer*

Currently, the workspace should look like this:

![](./Images/10.1.15.Workspace.png)

*10.1.15 Drive BC Workspace*
...
**14) Add the Date Time Converter**
...
![](./Images/10.1.27.DataStreaming.png)

*10.1.27 Data Streaming*
